...
async function viewActionCenter(root) {
  ...
  async function render() {
    ...
    container.append(el('div', { class: 'alert alert--info' },
      isTrainer
        ? 'قائمة مهامك اليومية: من غاب ويستحق تعويضًا، من لم يتوزّن، من اقترب اشتراكه من الانتهاء (قبل أسبوع فتجهّز خطته)، '
          + 'ومن بقي من مشتركيك بلا هدف تدريبي هذا الشهر. أنجِز المهمة ثم اضغط «تم التنفيذ» لتختفي من قائمتك.'
...
function actionCard(a, onDone) {
  ...
  /* أزرار الحالة — المدرب يشطب قراره بنفسه (قائمة مهام لا إشعارات) */
