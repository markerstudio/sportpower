/* ============================================================
   نشرة «ما الجديد» — للإدارة وحدها، مرة واحدة بعد كل تحديث.
   لا تُعرض للمدرب ولا للمحاسب ولا للمتدرب: هذه نشرة تشغيلية تخصّ من
   يدير النظام، لا إعلانًا لكل من يفتح التطبيق.
...
/* تُستدعى بعد أول رسم ناجح للواجهة — تعرض النشرة للإدارة إن لم ترها بعد.
...
function maybeShowWhatsNew() {
  ...
  if (API.user.role !== 'admin') return; // نشرة الإدارة وحدها
