...
const BRANCHES = [
  // لكل فرع عملته الصريحة: الضفة بالشيكل وعمّان بالدينار — لا تُقلب بإعدادٍ عام
  { id: 1, name: 'فرع بيت ساحور', address: 'بيت ساحور، فلسطين', phone: '02-2770000', currency: 'ILS' },
  { id: 2, name: 'فرع بيت لحم', address: 'بيت لحم، فلسطين', phone: '02-2740000', currency: 'ILS' },
