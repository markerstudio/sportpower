...
const SCHEMA = {
  ...
  users: {
    columns: {
      ...
      /* حسابٌ دُمج في غيره: يحمل معرّف الحساب الباقي. الصفّ يبقى (لا
         يُحذف) لأن الحذف يمحو اشتراكاته ودفعاتها بالتتابع — والعمود هو
         ما يمنع دمجه مرتين ويُخرجه من كشف التكرار. */
      mergedInto: col('int'),
